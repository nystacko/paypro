...
This module is for setting configuration settings for the app
************************************
"""
...
class Config(object):
    """ Set configuration settings for the app """
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'replace-this-key'
